...
const TRANSLATIONS = {
  ...
  ar: {
    ...
    'home.stat2.num':   '10',
    'home.stat2.label': ' سنوات في الجماعات الترابية',
    'home.stat3.num':   '4',
    ...
    'about.name':       'علي بزاع',
    'about.p1': 'أستاذ مؤهل بجامعة القاضي عياض بمراكش ومؤسس مكتب ALIB للاستشارات، علي بزاع يجمع بين الصرامة الأكاديمية والانتماء المؤسسي العميق. بأكثر من 10 سنوات من الخبرة في وزارة الداخلية، يُتقن تعقيدات الواقع الميداني للجماعات الترابية المغربية ويقدم حلولًا تمزج الابتكار البيداغوجي والخبرة التشغيلية.',
    'about.p2': 'حاصل على الدكتوراه في الاقتصاد والتسيير (جامعة الحسن الأول)، وإجازة في إدارة الأعمال (جامعة الأخوين)، يُدرّس اليوم استراتيجية المؤسسات و تحليل المعطيات بالجامعة — خبرة يضعها مباشرة في خدمة عملائه.',
    ...
    'about.cred4': '10 سنوات في الجماعات الترابية',
    ...
    'srv4.desc':  'مرافقة استراتيجية للجماعات الترابية والهيئات العمومية: إعداد مخططات التنمية (PAC/PDP/PDR)، برامج العمل، الحوكمة المحلية، قيادة التغيير وتعزيز القدرات. بخبرة ميدانية 10 سنوات في وزارة الداخلية.',
